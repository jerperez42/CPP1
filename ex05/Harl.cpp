...
/*   Updated: 2024/02/09 15:23:59 by jerperez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Harl::complain(std::string level)
{
	...
	const t_ptr_mem		farr[4] = {&Harl::debug, &Harl::info, &Harl::warning, &Harl::error};
	const std::string	narr[4] = {LVL_DEBUG, LVL_INFO, LVL_WARNING, LVL_ERROR};
